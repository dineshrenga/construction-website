  ...
  return (
    <section className="py-10 bg-white">
      <div className="max-w-[1536px] mx-auto px-4 md:px-10">
        <div className="flex flex-col lg:flex-row items-center gap-4 md:gap-16 lg:gap-24">

          {/* Left Side Content */}
          <div className="flex-1 space-y-4 md:space-y-8 animate-in fade-in slide-in-from-left duration-1000">
            <h2 className="text-2xl md:text-5xl font-black text-[#0d1117] leading-tight tracking-tighter">
              Furniture That Complements <br />
              <span className="text-[#f37021]">Your Construction</span>
            </h2>
            <p className="text-gray-600 text-sm md:text-xl font-bold leading-relaxed max-w-xl">
          ...
          <div className="flex-1 w-full animate-in fade-in slide-in-from-right duration-1000">
            <div className="relative md:rounded-[3rem] rounded-2xl overflow-hidden shadow-2xl border border-gray-100/50 aspect-video">
              <img
