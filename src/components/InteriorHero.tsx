...
export default function InteriorHero() {
  return (
    <section className="relative min-h-[calc(100vh-80px)] bg-white overflow-hidden flex flex-col pb-10">
      ...
      <div className="relative mx-6 mt-5 flex-grow hero-cutout-container bg-[#0b0f15] overflow-hidden flex flex-col justify-center">

        <div className="relative z-20 w-full max-w-[1536px] mx-auto px-10 lg:px-20 py-16 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          {/* Content on Right */}
          <div className="flex-1 text-white animate-in fade-in slide-in-from-right duration-1000 mt-10">
            <div className="space-y-8 max-w-xl">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-300 leading-relaxed font-bold tracking-tight">
              ...
              <button className="px-10 py-4 rounded-2xl border-2 border-[#f37021] text-[#f37021] font-black text-xl hover:bg-[#f37021] hover:text-white transition-all shadow-2xl shadow-[#f37021]/10">
                Get a Free Quote
              </button>
            </div>
          </div>
