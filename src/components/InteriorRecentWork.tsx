        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="flex-1 space-y-12">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-5xl font-black text-[#0d1117] leading-none tracking-tighter">
                Our Recent <span className="text-[#f37021]">Work</span>
              </h2>
              <p className="text-gray-600 text-md md:text-lg font-bold leading-relaxed max-w-xl">
            ...
            {/* Highlights Dark Box */}
            <div className="bg-[#0b0f15] rounded-2xl md:rounded-[2.5rem] p-4 md:p-10 lg:p-12 text-white shadow-2xl relative overflow-hidden group">
              <div className="relative z-10 space-y-4 md:space-y-8">
                <h3 className="text-2xl md:text-3xl font-black tracking-tight">Project Highlights</h3>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {["3D Visualizations", "Custom Furniture", "Turnkey Delivery", "Lighting Design"].map((item, i) => (
                    <li key={i} className="flex items-center gap-4 group/item">
                      ...
                      <span className="text-md md:text-lg font-bold text-gray-200">{item}</span>
                    </li>
                  ))}
                </ul>
